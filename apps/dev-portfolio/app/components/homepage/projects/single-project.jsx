      ...
      <div className='flex size-full flex-col items-center justify-between'>
        ...
        <div className="flex w-full items-center justify-between">
          <Link
            href={demo}
            target='_blank'
            className="flex size-10 cursor-pointer items-center justify-center rounded-full border-2 border-[#EFF3F4] box-decoration-clone text-[#EFF3F4] no-underline transition-all delay-[0.3s] duration-300 hover:scale-110 hover:border-[#0F0C41] hover:bg-[#231d4b] hover:text-violet-600">
            <FaPlay />
          </Link>
          ...
          <Link
            href={code}
            target='_blank'
            className="flex size-10 cursor-pointer items-center justify-center rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] no-underline transition-all delay-[0.3s] duration-300 hover:scale-110 hover:border-[#0F0C41] hover:bg-[#231d4b] hover:text-violet-600  group-hover:translate-x-[-140px]">
            <FaCode />
          </Link>
        </div>
      </div>
